...
{
    'name': 'GZ Finance - Document Hub',
    'version': '19.0.1.0.0',
    'author': 'Daniel Demedziuk (Adapted to Odoo 19 by GZ Consultoria)',
    'license': 'GPL-2',
    'sequence': 55,
    'category': 'Productivity/Documents',
    'summary': 'Advanced document management system for Odoo 19 Community - Finance Integration',
    'description': """
GZ Finance - Document Hub
==========================
An advanced document management module for Odoo 19 Community, inspired by the Odoo Enterprise "Documents" app. 
Enables centralized storage, categorization, sharing, and automation of document workflows within your company.

**Integrated with GZ Finance Core for financial document management**
